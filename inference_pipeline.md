...
8. **Similarity Matching:** Look up anchor queries for the chosen intent, compute cosine similarity, pick the best match. (in other words, compare input with anchors, select best, spit response corresponding to the anchor)
