	...
	public class MMapDirectory:FSDirectory
	{
		...
		internal void  CleanMapping(System.IO.MemoryStream buffer)
		{
			if (useUnmapHack)
			{
				...
				{
					var ioe = new System.IO.IOException("unable to unmap the mapped buffer", e.InnerException);
					throw ioe;
				}
			}
		}
		...
		protected internal class MultiMMapIndexInput:IndexInput, System.ICloneable
		{
			...
			public override System.Object Clone()
			{
				var clone = (MultiMMapIndexInput) base.Clone();
				clone.isClone = true;
				...
				{
                    var newException = new System.SystemException(ioe.Message, ioe);
					throw newException;
				}
				return clone;
			}
		...
		public override IndexInput OpenInput(System.String name, int bufferSize)
		{
			...
			var raf = new System.IO.FileStream(path, System.IO.FileMode.Open, System.IO.FileAccess.Read);
			try
			{
