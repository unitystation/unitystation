...
namespace Lucene.Net.QueryParsers {
    ...
    public class QueryParser : QueryParserConstants {
        ...
        public virtual DateTools.Resolution GetDateResolution(String fieldName) {
            ...
            var resolution = fieldToDateResolution[fieldName];
            if(resolution == null) {
        ...
        protected internal virtual Query GetFieldQuery(String field, String queryText, int slop) {
            var query = GetFieldQuery(field, queryText);
        ...
        protected internal virtual Query GetRangeQuery(String field,
            ...
            try {
                ...
                var resolution = GetDateResolution(field);
                if(resolution == null) {
        ...
        protected internal virtual Query GetBooleanQuery(IList<BooleanClause> clauses, bool disableCoord) {
            ...
            var query = NewBooleanQuery(disableCoord);
        ...
        public static void Main(String[] args) {
            ...
            var qp = new QueryParser(Version.LUCENE_CURRENT, "field", new SimpleAnalyzer());
            var q = qp.Parse(args[0]);
        ...
        public Query Term(String field) {
            ...
            switch((jj_ntk == -1) ? Jj_ntk() : jj_ntk) {
                ...
                case NumberToken:
                    ...
                    var termImage = DiscardEscapeChar(term.image);
                    if(wildcard) {
        ...
        private bool Jj_3R_2() {
            if(Jj_scan_token(TermToken)) {
                return true;
            }

            if(Jj_scan_token(ColonToken)) {
                return true;
            }
