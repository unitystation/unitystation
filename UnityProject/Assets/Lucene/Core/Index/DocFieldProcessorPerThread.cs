...
namespace Lucene.Net.Index
{
	...
	sealed class DocFieldProcessorPerThread:DocConsumerPerThread
	{
		...
		private void  Rehash()
		{
			...
			var newHashArray = new DocFieldProcessorPerField[newHashSize];
		...
		public override DocumentsWriter.DocWriter ProcessDocument()
		{
			...
			for (int i = 0; i < numDocFields; i++)
			{
                ...
                if (fp == null)
                {
                    ...
                    // easily add it
                    var fi = fieldInfos.Add(fieldName, field.IsIndexed, field.IsTermVectorStored,
			    ...
			    if (thisFieldGen != fp.lastGen)
				{
					...
					if (fieldCount == fields.Length)
					{
						...
						var newArray = new DocFieldProcessorPerField[newSize];
				...
				{
					var newArray = new IFieldable[fp.fields.Length * 2];
			...
			var one = fieldsWriter.FinishDocument();
			var two = consumer.FinishDocument();
			if (one == null)
			{
				return two;
			}
