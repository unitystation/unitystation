...
namespace Lucene.Net.Messages
{
	...
	public class NLS
	{
		...
		{
			var message = GetResourceBundleObject(key, locale);
			if (message == null)
			{
		...
		private static System.Object GetResourceBundleObject(System.String messageKey, System.Globalization.CultureInfo locale)
		{
			...
			{
                var clazz = bundles[it.Current];
				System.Threading.Thread.CurrentThread.CurrentUICulture = locale;
                var resourceBundle = System.Resources.ResourceManager.CreateFileBasedResourceManager(clazz.Name, "Messages", null); //{{Lucene.Net-2.9.1}} Can we make resourceDir "Messages" more general?
		...
		{
            var clazz = typeof (T);
            var fieldArray = clazz.GetFields(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.DeclaredOnly | System.Reflection.BindingFlags.Static);
		...
		private static void  ValidateMessage<T>(System.String key)
		{
			...
			try
			{
				...
				var resourceBundle = System.Resources.ResourceManager.CreateFileBasedResourceManager(clazz.FullName, "", null);
				if (resourceBundle != null)
				{
