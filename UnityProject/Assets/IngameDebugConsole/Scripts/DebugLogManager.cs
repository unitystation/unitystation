...
#pragma warning restore CS0649
		...
		public void LocalProfileButtonPressed()
		{
			if (Debug.isDebugBuild)
			{
				...
				Logger.Log("Running a local profile, saving on installation folder", Category.Unknown);
			}
			else
			{
				Logger.Log("Unable to run local profile, the build needs to be in development mode", Category.Unknown);
			}
		}
