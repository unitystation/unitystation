...
namespace Light2D
{
    ...
    static Windows.Devices.Input.TouchCapabilities touchCaps = new Windows.Devices.Input.TouchCapabilities();
		...
		public static Vector2 GetMousePosInUnits()
		{
			...
			Vector3 mouseWorld = camera.ScreenToWorldPoint(new Vector3(mouse.x, mouse.y, -camera.transform.position.z));
			return mouseWorld;
		}
		...
		{
			Camera camera = Camera.main;
			Vector3 mouseWorld = camera.ScreenToWorldPoint(new Vector3(screen.x, screen.y, -camera.transform.position.z));
			return mouseWorld;
		}
		...
		{
			Camera camera = Camera.main;
			Vector3 mouseWorld = camera.WorldToScreenPoint(new Vector3(screen.x, screen.y, -camera.transform.position.z));
			return mouseWorld;
		}
		...
		public static Vector4 EncodeFloatRGBA(float v)
		{
			...
			enc = new Vector3(enc.x - Mathf.Floor(enc.x), enc.y - Mathf.Floor(enc.y), enc.z - Mathf.Floor(enc.z));
			return enc;
		}

#if UNITY_EDITOR
		public static bool IsSceneViewFocused =>
			SceneView.currentDrawingSceneView != null && SceneView.currentDrawingSceneView == EditorWindow.focusedWindow;
#endif

		public static bool FastEquals(this Matrix4x4 m1, Matrix4x4 m2)
		{
			return m1.m00 == m2.m00 && m1.m01 == m2.m01 && m1.m02 == m2.m02 && m1.m03 == m2.m03 && m1.m10 == m2.m10 && m1.m11 == m2.m11 && m1.m12 == m2.m12 &&
			       m1.m13 == m2.m13 && m1.m20 == m2.m20 && m1.m21 == m2.m21 && m1.m22 == m2.m22 && m1.m23 == m2.m23 && m1.m30 == m2.m30 && m1.m31 == m2.m31 &&
