...
namespace UI
{
	...
	public class InventorySlotCache : MonoBehaviour, IEnumerable<UI_ItemSlot>
	{
		...
		private void Start()
		{
			slots = new[]
			{
				BackSlot, BeltSlot, EarSlot, EyesSlot, HandsSlot, HeadSlot, IDSlot, LeftHandSlot, LeftPocketSlot, MaskSlot, NeckSlot, RightHandSlot,
				RightPocketSlot, SuitSlot, SuitStorageSlot, ShoeSlot, UniformSlot
			};
		}
