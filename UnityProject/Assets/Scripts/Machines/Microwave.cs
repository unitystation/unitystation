...
public class Microwave : NetworkBehaviour, IAPCPowered
{
	...
	private void TransferToMicrowaveAndClose(ItemSlot fromSlot)
	{
		...
		// JESTER SoundManager.PlayNetworkedAtPos(DOOR_SOUND, WorldPosition, sourceObj: gameObject);
	}
	...
	private void StartMicrowave()
	{
		...
		// JESTER SoundManager.PlayNetworkedAtPos("MicrowaveStart", WorldPosition, sourceObj: gameObject);
		playAudioLoop = true;
	}
	...
	private void AddTime(int seconds)
	{
		...
		// JESTER SoundManager.PlayNetworkedAtPos(TIMER_BEEP, WorldPosition, sourceObj: gameObject, pitch: seconds < 0 ? 0.8f : 1);
	}

	private void MicrowaveTimerComplete()
	{
		HaltMicrowave();
		// JESTER SoundManager.PlayNetworkedAtPos("MicrowaveDing", WorldPosition, sourceObj: gameObject);
