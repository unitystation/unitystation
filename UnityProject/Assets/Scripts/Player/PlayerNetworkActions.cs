...
public partial class PlayerNetworkActions : NetworkBehaviour
{
	...
	{
		if (AdminCommandsManager.IsAdmin(connectionToClient, out var player, "ADMIN_VETO_VOTE"))
		{
			if (VotingManager.Instance == null) return;
	...
	{
		if (AdminCommandsManager.IsAdmin(connectionToClient, out _,  "ADMIN_RESPAWN_SELF",false) || GameManager.Instance.RespawnCurrentlyAllowed)
		{
			ServerRespawnPlayer();
		}
	}
