...
public class PlayerSprites : MonoBehaviour
{
	...
	private void OnDestroy() => playerHealth.OnClientFireStacksChange.RemoveListener(OnClientFireStacksChange);
	...
	private void OnClientFireStacksChange(float newStacks) => UpdateBurningOverlays(newStacks, directional.CurrentDirection);
	...
	/// </summary>
	public void DisableElectrocutedOverlay() => electrocutedOverlay.StopOverlay();
	...
	private bool IsBitSet(ulong b, int pos) => ((b >> pos) & 1) != 0;
