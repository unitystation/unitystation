...
public class PlayerScript : NetworkBehaviour, IMatrixRotation, IAdminInfo, IActionGUI
{
	...
	[Server]
	public void SetPlayerChatLocation(GameObject newLocation) => playerChatLocation = newLocation;
	...
	public bool IsRegisterTileReachable(RegisterTile otherObject, bool isServer, float interactDist = interactionDistance, GameObject context = null) => Validations.IsReachableByRegisterTiles(RegisterTile, otherObject, isServer, interactDist, context: context);
	...
	public bool IsPositionReachable(Vector3 otherPosition, bool isServer, float interactDist = interactionDistance, GameObject context = null) => Validations.IsReachableByPositions(isServer ? RegisterTile.WorldPositionServer : RegisterTile.WorldPositionClient, otherPosition, isServer, interactDist, context: context);
	...
	// Syncvisiblename
	public void SyncVisibleName(string oldValue, string value) => visibleName = value;
	...
	public void OnMouseExit() => UIManager.SetToolTip = "";
    ...
    public string AdminInfoString()
    {
        ...
        if (mind != null && mind.IsAntag)
        {
            ...
            stringBuilder.AppendLine($"Antag: {mind.Antag.Antagonist.AntagJobType}");
            stringBuilder.AppendLine($"Objectives : {mind.Antag.GetObjectiveSummary()}</color>");
        }

        return stringBuilder.ToString();
    }

	public void CallActionClient() => PlayerNetworkActions.CmdAskforAntagObjectives();
