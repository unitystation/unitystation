...
public class PlayerManager : SingletonManager<PlayerManager>
{
	...
	private void OnLevelFinishedLoading(Scene oldScene, Scene newScene) => Reset();
	...
	public static void SetViewerForControl(JoinedViewer viewer) => LocalViewerScript = viewer;
	...
	/// </summary>
	public static void SetMovementControllable(IPlayerControllable controllable) => MovementControllable = controllable;
	...
	private void OnPlayerDeath() => EventManager.Broadcast(Event.DisableInternals);
