...
namespace Systems.Teleport
{
	...
	public static class TeleportUtils
    {
        ...
        {
            var playerBodies = Object.FindObjectsOfType(typeof(PlayerScript));
        ...
        {
            var placeGameObjects = Object.FindObjectsOfType(typeof(SpawnPoint));
        ...
        public static IEnumerable<TeleportInfo> GetCameraDestinations()
        {
            ...
            var securityCameras = Object.FindObjectsOfType<SecurityCamera>();
        ...
        public static IEnumerable<TeleportInfo> GetCameraTrackPlayerDestinations()
        {
            ...
            //Check for players
            var playerScripts = Object.FindObjectsOfType<PlayerScript>();
            ...
            //Check for mobs
            var mobScripts = Object.FindObjectsOfType<MobAI>();
        ...
        public static void TeleportLocalGhostTo(TeleportInfo teleportInfo)
        {
            ...
            var playerPosition = PlayerManager.LocalPlayer.GetComponent<RegisterTile>().WorldPositionClient;//Finds current player coords
		...
		public static void TeleportLocalGhostTo(Vector3 vector) => PlayerManager.LocalPlayerScript.PlayerNetworkActions.CmdGhostPerformTeleport(vector);
