...
public class Mind
{
	...
	public void StopGhosting() => IsGhosting = false;
	...
	public T GetPropertyOrDefault<T>(string key, T defaultValue) => properties.GetOrDefault(key, defaultValue) is T typedProperty ? typedProperty : defaultValue;
}