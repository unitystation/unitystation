...
public class CommConsole : NBHandApplyInteractable
{
    public IDCard IdCard;
    public CommunicationsUpdateEvent OnConsoleUpdate = new CommunicationsUpdateEvent();
...
public class CommunicationsUpdateEvent : UnityEvent { }