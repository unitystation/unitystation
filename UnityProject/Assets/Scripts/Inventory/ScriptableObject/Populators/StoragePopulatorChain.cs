...
/// </summary>
[CreateAssetMenu(fileName = "StoragePopulatorChain", menuName = "Inventory/Populators/StoragePopulatorChain", order = 3)]
public class StoragePopulatorChain : ItemStoragePopulator
{
	...
	public override void PopulateItemStorage(ItemStorage toPopulate, PopulationContext context)
	{
		...
		{
			populator.PopulateItemStorage(toPopulate, context);
		}
	}
}
