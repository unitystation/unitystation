...
public class PowerSupplyControlInheritance //: //InputTrigger//, IDeviceControl
{
	...
	//	ElectricalSynchronisation.NUStructureChangeReact.Add(powerSupply.InData.ControllingDevice);
	//	ElectricalSynchronisation.NUResistanceChange.Add(powerSupply.InData.ControllingDevice);
	//	ElectricalSynchronisation.NUCurrentChange.Add(powerSupply.InData.ControllingDevice);
	//}
