...
using UnityEditor;
	...
	public class AirLockAnimator : DoorAnimator
	{
		...
		public override void AccessDenied(bool skipAnimation)
		{
			...
			// JESTER SoundManager.PlayAtPosition("AccessDenied", transform.position, gameObject);
		...
		public override void PressureWarn(bool skipAnimation)
		{
			...
			doorController.isPerformingAction = true;
			// JESTER SoundManager.PlayAtPosition("TripleBeep", transform.position, gameObject, polyphonic: true, isGlobal: true);
