...
namespace Atmospherics
{
	public struct Gas
	{
		...
		public static readonly Gas WaterVapor = new Gas("Water Vapor", 40, 44.01f, true, 0, "WaterVapour", -9);
		public static readonly Gas BZ = new Gas("BZ", 20, 44.01f, false, 0, "NONE", -3);
		public static readonly Gas Miasma = new Gas("Miasma", 20, 44.01f, true, 0, "Miasma", -7);
		public static readonly Gas Nitryl = new Gas("Nitryl", 20, 44.01f, true, 0, "Nitryl", -6);
		public static readonly Gas Tritium = new Gas("Tritium", 10, 44.01f, true, 0, "Tritium", -3);
		...
		public static readonly Gas Freon = new Gas("Freon", 300, 44.01f, true, 0, "Freon", -8);
