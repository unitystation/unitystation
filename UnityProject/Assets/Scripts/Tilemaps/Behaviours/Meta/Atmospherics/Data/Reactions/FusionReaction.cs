...
namespace Systems.Atmospherics
{
	public class FusionReaction : Reaction
	{
		...
		public void React(GasMix gasMix, MetaDataNode node)
		{
			...
			if (reactionEnergy != 0)
			{
				RadiationManager.Instance.RequestPulse(node.LocalPosition.ToWorld(node.PositionMatrix).RoundToInt(), Mathf.Max((AtmosDefines.FUSION_RAD_COEFFICIENT/instability)+ AtmosDefines.FUSION_RAD_MAX, 0), rnd.Next(Int32.MinValue, Int32.MaxValue));
