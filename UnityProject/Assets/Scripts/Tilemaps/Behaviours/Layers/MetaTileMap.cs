...
public class MetaTileMap : MonoBehaviour
{
    ...
    public LayerType[] LayersKeys {
        get;
        private set;
    }
    public Layer[] LayersValues {
        get;
        private set;
    }
    ...
    /// </summary>
    public Layer[] SolidLayersValues {
        get;
        private set;
    }
    ...
    public bool UnderFloorUtilitiesInitialised {
        get;
        private set;
    } = false;
