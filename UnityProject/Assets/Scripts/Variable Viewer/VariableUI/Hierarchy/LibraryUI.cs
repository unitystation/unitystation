...
public class LibraryUI : MonoBehaviour
{
	...
	public Dictionary<ulong, HierarchyEntry> IDtoHierarchyEntry =
		new Dictionary<ulong, HierarchyEntry>();

	public List<VariableViewerNetworking.NetFriendlyHierarchyBookShelf> Roots = new List<VariableViewerNetworking.NetFriendlyHierarchyBookShelf>();
