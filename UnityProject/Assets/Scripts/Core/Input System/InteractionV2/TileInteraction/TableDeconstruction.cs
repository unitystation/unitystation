...
{
	/// <summary>
	/// Deconstruct the table and spawn its deconstruction object (if defined) and (optionally) additional objects when an item with a particular
	/// trait is used on the table.
	/// </summary>\
