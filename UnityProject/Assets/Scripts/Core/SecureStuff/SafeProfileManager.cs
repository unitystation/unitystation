...
namespace SecureStuff
{
	public sealed class SafeProfileManager : MonoBehaviour
	{
		...
		public void RunMemoryProfile(bool full = true)
		{
			...
			if (full)
			{
				MemoryProfiler.TakeSnapshot($"Profiles/FullMemoryProfile{DateTime.Now:yyyy-MM-dd HH-mm-ss}.snap",
					MemoryProfileEnd,
			...
			MemoryProfiler.TakeSnapshot($"Profiles/ManagedMemoryProfile{DateTime.Now:yyyy-MM-dd HH-mm-ss}.snap",
				MemoryProfileEnd,
