	...
	public class AutoMod : MonoBehaviour, IInitialise
	{
		...
		private void LoadConfig()
		{
			if (File.Exists(AutoModConfigPath))
			{
				...
				Logger.Log("Successfully loaded Auto Mod config", Category.Unknown);
			}
		}
		...
		public static void ProcessAllocationAttack(string ipAddress)
		{
			...
			{
				Logger.Log($"Auto mod has taken steps to protect against an allocation attack from {ipAddress}", Category.Unknown);
