...
namespace US13.Player.MovementV2
{
		...
		IBumpableObject, ICheckedInteractable<ContextMenuApply>
	{
		...
		public void ReceivePlayerMoveAction(PlayerAction moveActions)
		{
			...
			{
				var dummyMind = PlayerSpawn.NewSpawnCharacterV2(EnumerableExt.PickRandom(OccupationList.Instance.Occupations),
