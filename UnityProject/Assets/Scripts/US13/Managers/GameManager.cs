...
namespace US13.Managers
{
	public partial class GameManager : MonoBehaviour, IInitialise
	{
		...
		private void Start()
		{
			UpdateManager.UpdateManager.Add(UpdateMinutes, 60f);
		...
		private void OnDisable()
		{
			...
			UpdateManager.UpdateManager.Remove(CallbackType.PERIODIC_UPDATE, UpdateMinutes);
			...
			while (validPos == false)
			{
				...
				bool failedChecks =
					Vector3.Distance(proposedPosition,
						MatrixManager.MatrixManager.Instance.spaceMatrix.transform.parent.transform.position) <
