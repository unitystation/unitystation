...
namespace US13.Managers.NetworkManagement
{
	public class CustomNetworkManager : NetworkManager, IInitialise
	{
		...
		{
			if (data == null) return;
			var Matrix = MatrixManager.MatrixManager.Get(MatrixID);
		...
		void IInitialise.Initialise()
		{
			...
			var prevEditorScene = SubSceneManager.SubSceneManager.GetEditorPrevScene();
		...
		public override void OnServerAddPlayer(NetworkConnectionToClient conn)
		{
			...
			SubSceneManager.SubSceneManager.Instance.AddNewObserverScenePermissions(conn);
		...
		public override void OnServerDisconnect(NetworkConnectionToClient conn)
		{
			...
			SubSceneManager.SubSceneManager.Instance.RemoveSceneObserver(conn);
		}
		...
		private void OnLevelFinishedLoading(Scene oldScene, Scene newScene)
		{
			...
			else
			{
				...
				LobbyManager.LobbyManager.Instance.WasDisconnected = true;
			}
		}
