...
namespace US13.Managers.MatrixManager
{
	...
	public partial class MatrixManager : SingletonManager<MatrixManager>
	{
		...
		public static Matrix MakeNewMatrix(string Name = "Matrix", SceneType SceneType = SceneType.AdditionalScenes)
		{
			...
			var MatrixPrefab = SubSceneManager.SubSceneManager.Instance?.NetworkedMatrixPrefab;
		...
		private bool AreAllMatrixReady()
		{
			...
			Count = SubSceneManager.SubSceneManager.Instance.loadedScenesList.Count;

			if (Count != InitializingMatrixes.Count || SubSceneManager.SubSceneManager.Instance.clientIsLoadingSubscene || SubSceneManager.SubSceneManager.Instance.SubSceneManagerNetworked.ScenesInitialLoadingComplete == false)
			{
				return false;
			}
		...
		public static bool IsPassableAtAllMatrices(Vector3 worldOrigin, Vector3 worldTarget, bool isServer,
			...
			List<IBumpableObject> Bumps, List<UniversalObjectPhysics> Hits = null, ICustomTilePassable ICustomTilePassable = null)
		{
			...
			var CollisionType = global::US13.Managers.MatrixManager.CollisionType.Player;
