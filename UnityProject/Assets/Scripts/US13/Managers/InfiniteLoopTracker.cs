...
namespace US13.Managers
{
	public class InfiniteLoopTracker : SingletonManager<InfiniteLoopTracker>
	{
        ...
        private void ReportLastCheckpoint()
        {
	        ...
	        if (UpdateManager.UpdateManager.Instance.MidInvokeCalls)
	        {
		        ...
		        {
			        var className = UpdateManager.UpdateManager.Instance.LastInvokedAction.Method.ReflectedType.ToString();
			        var methodName = UpdateManager.UpdateManager.Instance.LastInvokedAction.Method.Name;
