...
using US13.Systems.Research.Objects;
	...
	public class BlastYieldDetector : ResearchPointMachine, ICanOpenNetTab, ICheckedInteractable<HandApply>
	{
		...
		private void DetectBlast(Vector3Int pos, BlastData blastData)
		{
			...
			if (angle <= 45)
			{
				...
				{
					global::Chemistry.Effect effectType = effect.effectType;
		...
		private bool IsCorrectExplosionType(EffectBountyEntry bountyEntry, global::Chemistry.Effect effect)
		{
