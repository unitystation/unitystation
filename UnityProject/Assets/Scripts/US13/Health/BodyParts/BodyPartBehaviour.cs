...
namespace US13.Health.BodyParts
{
	public class BodyPartBehaviour : MonoBehaviour
	{
		...
		public virtual void ReceiveDamage(DamageType damageType, float damage)
		{
			...
			Loggy.Trace().Format("{0} received {1} {2} damage. Total {3}/{4}, limb condition is {5}", Category.Damage, Type, damage, damageType, damage, MaxDamage, Severity);
		}
