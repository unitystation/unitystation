...
namespace US13.Items
{
	...
	public class PlaceableTileReplaceBase : MonoBehaviour, ICheckedInteractable<PositionalHandApply>
	{
		...
		[SerializeField]
		private List<PlaceableTileReplaceBaseEntry> waysToPlace = null;
		...
		public void ServerPerformInteraction(PositionalHandApply interaction)
		{
			...
			PlaceableTileReplaceBaseEntry placeableTileEntry = null;
		...
		private static bool EntryMatches(PlaceableTileReplaceBaseEntry entry, LayerTile tileAtPosition)
		{
		...
		/// </summary>
		[Serializable]
		private class PlaceableTileReplaceBaseEntry
		{
			[Tooltip("Layer tile which this will create when placed.")]
			public LayerTile layerTile = null;

			[Tooltip("Layer tile which will be placed before this tile. e.g. raplace sand with plate when placing floor tile")]
			public LayerTile layerTileToReplaceBase = null;
