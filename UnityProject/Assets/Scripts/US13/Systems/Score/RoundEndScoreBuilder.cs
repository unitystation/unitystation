...
namespace US13.Systems.Score
{
	...
	public partial class RoundEndScoreBuilder : SingletonManager<RoundEndScoreBuilder>
	{
		...
		public void CalculateScoresAndShow()
		{
			...
			List<ScoreEntry.ScoreEntry> stationScoreEntries = new List<ScoreEntry.ScoreEntry>();
			List<ScoreEntry.ScoreEntry> antagScoreEntries = new List<ScoreEntry.ScoreEntry>();
