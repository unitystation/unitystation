...
namespace US13.Systems.Score
{
	public class ScoreMachine : SingletonManager<ScoreMachine>
	{
		public Dictionary<string, ScoreEntry.ScoreEntry> Scores { get; private set; }
		...
		public override void Awake()
		{
			...
			Scores = new Dictionary<string, ScoreEntry.ScoreEntry>(); //This only works if set on Awake()
		}
		...
		public static String ScoreTypeResultAsString(ScoreEntry.ScoreEntry entry)
		{
			return entry switch
			{
