...
using US13.Systems.Occupations.OccupationCustomEffects;
using US13.Systems.Spells;

namespace US13.Systems.Occupations
{
	/// <summary>
	...
	public class Occupation : ScriptableObject
	{
		...
		private List<Clearance.Clearance> issuedClearance = default;
		public List<Clearance.Clearance> IssuedClearance
		{
			get => issuedClearance;
		...
		private List<Clearance.Clearance> issuedLowPopClearance = default;
		public List<Clearance.Clearance> IssuedLowPopClearance
		{
