...
namespace US13.Systems.Antagonists
{
	...
	public abstract class Objective : ScriptableObject
	{
		...
		/// <summary>
		/// Relative weighting used when randomly picking this objective out of a shared pool.
		/// Higher values make it more likely to be picked, lower values rarer. Defaults to 1 (normal chance).
		/// </summary>
