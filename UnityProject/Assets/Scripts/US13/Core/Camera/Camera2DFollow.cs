...
namespace US13.Core.Camera
{
	public class Camera2DFollow : MonoBehaviour
	{
		...
		public UnityEngine.Transform starsBackground;
		...
		public UnityEngine.Transform FOVtarget;
		...
		public void SetCameraXOffset()
		{
			return;
			float xOffSet =
				(transform.position.x - UnityEngine.Camera.main.ScreenToWorldPoint(UIManager.Instance.transform.position).x) * 1.38f;
		...
		private void UpdateMe()
		{
			...
			CommonInput.CashedMouseWorldPosition = UnityEngine.Camera.main.ScreenToWorldPoint(CommonInput.mousePosition);
		}
