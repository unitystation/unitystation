...
using US13.UI.Systems.ChatChannel;
...
namespace US13.Core.Chat
{
	public class ChatUI : SingletonManager<ChatUI>
	{
		...
		public void SetPreferenceChatContent(float preference)
		{
			...
			UnityEngine.PlayerPrefs.SetFloat(PlayerPrefKeys.ChatContentMinimumAlpha, preference);
			UnityEngine.PlayerPrefs.Save();
		}

		public float GetPreferenceChatContent()
		{
			if (UnityEngine.PlayerPrefs.HasKey(PlayerPrefKeys.ChatContentMinimumAlpha))
			{
				return UnityEngine.PlayerPrefs.GetFloat(PlayerPrefKeys.ChatContentMinimumAlpha);
			}
			else
			{
				UnityEngine.PlayerPrefs.SetFloat(PlayerPrefKeys.ChatContentMinimumAlpha, 0);
				UnityEngine.PlayerPrefs.Save();
				return 0f;
			}
		}
		...
		public void SetPreferenceChatBackground(float preference)
		{
			...
			UnityEngine.PlayerPrefs.SetFloat(PlayerPrefKeys.ChatBackgroundMinimumAlpha, preference);
			UnityEngine.PlayerPrefs.Save();
		}

		public float GetPreferenceChatBackground()
		{
			if (UnityEngine.PlayerPrefs.HasKey(PlayerPrefKeys.ChatBackgroundMinimumAlpha))
			{
				return UnityEngine.PlayerPrefs.GetFloat(PlayerPrefKeys.ChatBackgroundMinimumAlpha);
			}
			else
			{
				UnityEngine.PlayerPrefs.SetFloat(PlayerPrefKeys.ChatBackgroundMinimumAlpha, 0);
				UnityEngine.PlayerPrefs.Save();
				return 0f;
			}
		}
