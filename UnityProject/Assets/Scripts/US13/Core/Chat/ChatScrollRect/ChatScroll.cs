...
namespace US13.Core.Chat.ChatScrollRect
{
	/// <summary>
	...
	{
		[SerializeField] private UnityEngine.Transform chatContentParent = null;
		...
		{
			foreach (UnityEngine.Transform t in chatContentParent.transform)
			{
