...
namespace US13.Core.Account
{
	...
	public class Account
	{
		...
		private void UpdateAccountCache()
		{
			...
			if (UnityEngine.PlayerPrefs.GetInt(PlayerPrefKeys.AccountAutoLogin) == 1)
			{
				UnityEngine.PlayerPrefs.SetString(PlayerPrefKeys.AccountName, Username);
				UnityEngine.PlayerPrefs.SetString(PlayerPrefKeys.AccountToken, Token);
			}
		...
		{
			UnityEngine.PlayerPrefs.DeleteKey(PlayerPrefKeys.AccountName);
