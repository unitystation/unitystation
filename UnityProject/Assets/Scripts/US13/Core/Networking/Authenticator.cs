...
namespace US13.Core.Networking
{
	...
	public class Authenticator : NetworkAuthenticator
	{
		...
		private async Task<Account.Account> TryGetPlayerAccount(NetworkConnectionToClient conn, string accountId, string playerToken)
		{
			...
			return Account.Account.FromAccountGetResponse(accountResponse.Data);
		}

		private bool ValidatePlayerAccount(NetworkConnectionToClient conn, Account.Account account)
		{
