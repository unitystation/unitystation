...
namespace US13.Core.Lighting
{
	...
	public class ElectricalArcGlow : MonoBehaviour
	{
		...
		[SerializeField]
		private UnityEngine.Transform ambientTransform = default;
		[SerializeField]
		private UnityEngine.Transform startTransform = default;
		[SerializeField]
		private UnityEngine.Transform endTransform = default;
