...
namespace US13.Core.Lifecycle
{
	...
	public class SpawnDestination
	{
		...
		private SpawnDestination(Vector3 worldPosition, UnityEngine.Transform parent, Quaternion localRotation,
		...
		/// <returns></returns>
		public static SpawnDestination At(Vector3? worldPosition = null, UnityEngine.Transform parent = null,
		...
		private static UnityEngine.Transform DefaultParent(UnityEngine.Transform parent, Vector3? worldPos)
		{
