...
namespace US13.Core.Lifecycle
{
	...
	public static class SpawnSafeThread
	{
		...
		public static void SpawnPrefab(Vector3 tileWorldPos, GameObject prefabObject, UnityEngine.Transform parentTransform = null,
	...
	public class SpawnSafeThreadData
	{
		...
		public SpawnSafeThreadData(Vector3 worldPosition, GameObject prefab, UnityEngine.Transform parentTransform, int amount,
