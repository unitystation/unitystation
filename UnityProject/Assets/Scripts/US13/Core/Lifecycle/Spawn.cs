...
namespace US13.Core.Lifecycle
{
	...
	public static class Spawn
	{
		...
		public static SpawnResult ServerPrefab(GameObject prefab, Vector3? worldPosition = null, UnityEngine.Transform parent = null,
		...
		/// null (no scatter).</param>
		/// <returns>the newly created GameObject</returns>
		public static SpawnResult ClientPrefab(GameObject prefab, Vector3? worldPosition = null, UnityEngine.Transform parent = null,
		...
		/// <param name="cancelIfImpassable">If true, the spawn will be cancelled if the location being spawned into is totally impassable.</param>
		/// <returns>the newly created GameObject</returns>
		public static SpawnResult ServerPrefab(string prefabName, Vector3? worldPosition = null, UnityEngine.Transform parent = null,
		...
		/// null (no scatter).</param>
		/// <returns>the newly created GameObject</returns>
		public static SpawnResult ClientPrefab(string prefabName, Vector3? worldPosition = null, UnityEngine.Transform parent = null,
			Quaternion? localRotation = null, int count = 1, float? scatterRadius = null, bool mapspawn = false)
		{
			return Client(
				SpawnInfo.Spawnable(
		...
		/// usually take care of properly parenting themselves when spawned so in many cases you can leave it null.</param>
		/// <returns>the newly created GameObject</returns>
		public static SpawnResult ServerClone(GameObject toClone, Vector3? worldPosition = null, UnityEngine.Transform parent = null,
