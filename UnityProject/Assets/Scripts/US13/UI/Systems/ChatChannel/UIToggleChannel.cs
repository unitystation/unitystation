...
namespace US13.UI.Systems.ChatChannel
{
	...
	{
		public US13.Core.Chat.ChatChannel Channel { get; private set; }
		...
		public Toggle SetToggle(US13.Core.Chat.ChatChannel _channel)
		{
			Channel = _channel;
		...
		private string ConstructTooltipText()
		{
			...
			if (prefix.Value is not US13.Core.Chat.ChatChannel.Binary)
			{
