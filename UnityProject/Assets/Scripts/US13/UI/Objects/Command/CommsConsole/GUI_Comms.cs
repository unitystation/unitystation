...
namespace US13.UI.Objects.Command.CommsConsole
{
	public class GUI_Comms : NetTab
	{
		...
		private US13.Objects.Consoles.CommsConsole console;
		...
		private IEnumerator WaitForProvider()
		{
			...
			console = Provider.GetComponentInChildren<US13.Objects.Consoles.CommsConsole>();
