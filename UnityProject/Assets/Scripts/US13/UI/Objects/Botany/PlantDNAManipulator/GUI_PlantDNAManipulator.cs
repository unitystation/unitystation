...
namespace US13.UI.Objects.Botany.PlantDNAManipulator
{
	public class GUI_PlantDNAManipulator : NetTab
	{
		...
		public US13.Objects.Botany.PlantDNAManipulator PlantDNAManipulator;
		...
		private void Start()
		{
			if (Provider != null)
			{
				PlantDNAManipulator = Provider.GetComponentInChildren<US13.Objects.Botany.PlantDNAManipulator>();
