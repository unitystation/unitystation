...
namespace US13.UI.Objects.Botany.SeedExtractor
{
	public class GUI_SeedExtractor : NetTab
	{
		...
		private US13.Objects.Botany.SeedExtractor seedExtractor;
		private Dictionary<string, List<US13.Objects.Botany.SeedExtractor.SeedAndPlantData>> seedExtractorContent = new Dictionary<string, List<US13.Objects.Botany.SeedExtractor.SeedAndPlantData>>();
		[SerializeField]
		...
		private IEnumerator WaitForProvider()
		{
			...
			seedExtractor = Provider.GetComponent<US13.Objects.Botany.SeedExtractor>();
		...
		private void GenerateContentList()
		{
			...
			seedExtractorContent = new Dictionary<string, List<US13.Objects.Botany.SeedExtractor.SeedAndPlantData>>();
			foreach (var seedPacket in seedExtractor.seedPackets)
			{
				...
				{
					seedExtractorContent.Add(seedPacket.SeedPacket.name, new List<US13.Objects.Botany.SeedExtractor.SeedAndPlantData> { seedPacket });
				}
			}
		}
		...
		/// </summary>
		public void DispenseSeedPacket(US13.Objects.Botany.SeedExtractor.SeedAndPlantData seedPacket)
		{
			if (!CanSell()) return;
