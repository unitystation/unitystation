...
namespace US13.UI.Objects.Common.Autolathe
{
	public class GUI_Autolathe : NetTab
	{
		...
		private US13.Objects.Machines.Autolathe.Autolathe autolathe;
		public US13.Objects.Machines.Autolathe.Autolathe Autolathe => autolathe;
		...
		private IEnumerator WaitForProvider()
		{
			...
			autolathe = Provider.GetComponentInChildren<US13.Objects.Machines.Autolathe.Autolathe>();
			//Subscribes to the MaterialsManipulated event
			US13.Objects.Machines.Autolathe.Autolathe.MaterialsManipulated += UpdateMaterialsDisplay;
