...
using US13.UI.Objects.Atmospherics.ACU.Templates;
using Util;
...
namespace US13.UI.Objects.Atmospherics.ACU.Pages
{
	...
	public class GUI_AcuDevicesPage : GUI_AcuPage
	{
		...
		{
			List<AirVent> vents = SweetExtensions.OfType<AirVent>(Acu.ConnectedDevices).ToList();
		...
		{
			List<Scrubber> scrubbers = SweetExtensions.OfType<Scrubber>(Acu.ConnectedDevices).ToList();
