...
namespace US13.UI.Objects.Atmospherics.Canister
{
	public class GUI_Canister : NetTab
	{
		...
		private US13.Objects.Canisters.Canister canister;
		...
		private IEnumerator ServerWaitForProvider()
		{
			...
			canister = Provider.GetComponent<US13.Objects.Canisters.Canister>();
		...
		public void ServerEditReleasePressure(string newValue)
		{
			...
			{
				releasePressure = Mathf.Clamp(releasePressure, 0, US13.Objects.Canisters.Canister.MAX_RELEASE_PRESSURE);
