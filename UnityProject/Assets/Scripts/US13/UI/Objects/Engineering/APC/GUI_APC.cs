...
namespace US13.UI.Objects.Engineering.APC
{
	public class GUI_APC : NetTab
	{
		...
		/// </summary>
		private US13.Objects.Engineering.APC LocalAPC;
		...
		private void Start()
		{
			if (IsMasterTab)
			{
				...
				LocalAPC = Provider.GetComponent<US13.Objects.Engineering.APC>();
		...
		{
			if (LocalAPC.State != US13.Objects.Engineering.APC.APCState.Dead)
			{
