...
namespace US13.UI.Core.RightClick
{
	/// <summary>
	...
	public class RightClickManager : SingletonManager<RightClickManager>
	{
		...
		[SerializeField]
		private global::US13.ScriptableObjects.RightClickOptionsList rightClickOptions = default;
		...
		{
			var Prefere=  UnityEngine.PlayerPrefs.GetString("RightClickPreference", AvailableRightClickOptions.Keys.First());
