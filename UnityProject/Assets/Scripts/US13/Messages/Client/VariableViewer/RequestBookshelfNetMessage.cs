	...
	public class RequestBookshelfNetMessage : ClientMessage<RequestBookshelfNetMessage.NetMessage>
	{
		...
		private void ValidateAdmin(NetMessage msg)
		{
			...
			if (msg.TheObjectToView != 0)
			{
				...
				{
					global::US13.Variable_Viewer.BookViewer.VariableViewer.ProcessTransform(NetworkObject.transform,SentByPlayer.GameObject,msg.RefreshHierarchy, msg.TeleportTo );
				}
			}
			else
			{
				global::US13.Variable_Viewer.BookViewer.VariableViewer.RequestSendBookshelf(msg.BookshelfID, msg.IsNewBookshelf, SentByPlayer.GameObject, msg.TeleportTo);
			}
