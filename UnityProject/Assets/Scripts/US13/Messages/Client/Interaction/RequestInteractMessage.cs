...
namespace US13.Messages.Client.Interaction
{
	/// <summary>
	...
	public class RequestInteractMessage : ClientMessage<RequestInteractMessage.NetMessage>
	{
		...
		static RequestInteractMessage()
		{
			...
			var alphabeticalInteractionTypes =
				typeof(global::US13.Core.Input_System.InteractionV2.Interactions.Internal.Interaction).Assembly.GetTypes()
					.Where(type => typeof(global::US13.Core.Input_System.InteractionV2.Interactions.Internal.Interaction).IsAssignableFrom(type))
		...
		private void ProcessInteraction<T>(T interaction, GameObject processorObj, Type ComponentType)
			where T : global::US13.Core.Input_System.InteractionV2.Interactions.Internal.Interaction
		{
		...
		private static bool ServerCheckAndTrigger<T>(T interaction, IEnumerable<IInteractable<T>> interactables) where T : global::US13.Core.Input_System.InteractionV2.Interactions.Internal.Interaction
		{
