...
namespace US13.Variable_Viewer.BookViewer.ElementDisplay.ElementTypes.Enum
{
	public class GUI_P_Enum : PageElement
	{
				...
				VariableViewerNetworking.NetFriendlySentence Sentence = null, bool Iskey = false)
		{
			...
			var values = System.Enum.GetValues(ValueType);
		...
		{
			return System.Enum.ToObject(InType, 0);
		}
