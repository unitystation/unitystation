...
using US13.Systems.Electricity.Wire;
...
namespace US13.Tilemaps.Behaviours.Layers
{
	...
	public class Matrix : MonoBehaviour
	{
		...
		public IEnumerable<DisposalPipe> GetDisposalPipesAt(Vector3Int position)
		{
			// Return a list, because we may allow disposal pipes to overlap each other - NS with EW e.g.
			return metaTileMap.GetAllTilesByType<DisposalPipe>(position, LayerType.Disposals);
		}
