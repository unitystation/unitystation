...
namespace US13.ScriptableObjects.TimedGameEvents
{
    ...
    {
        // Now a list of months instead of a single month.
        public List<Month> Months;

        // Custom range class to define start and end days within each month.
        [System.Serializable]
        ...
        // Dictionary to map each month to its corresponding day ranges.
        public SerializableDictionary<Month, DayRange> MonthDayRanges = new SerializableDictionary<Month, DayRange>();
