...
namespace Wiring
{
    ...
    public class StructurePowerWire : MonoBehaviour
    {
        ...
        {
            var spritePath = DirectionStart + (DirectionEnd != 0 ? "_" + DirectionEnd : "");
            var Color = SpriteManager.WireSprites[this.Color.ToString()];
            ...
            var spriteIndex = WireDirections.GetSpriteIndex(spritePath);
