...
namespace Managers
{
	...
	public partial class GameManager
	{
		...
		{
			var selectedGM = GameModeData.GetGameMode(gmName);
		...
		{
			var randomGM = GameModeData.PickFromCarouselGameMode();
		...
		{
			var randomGM = GameModeData.ChooseGameMode();
			SetGameMode(randomGM);
		}
		...
		{
			if (SecretGameMode && overrideSecret == false) return "Secret";
