...
public static class BoundsExtensions {
  public static bool BoundsIntersect(this MatrixInfo matrix,
                                     MatrixInfo otherMatrix,
                                     out BetterBounds intersection) {
  ...
  public static BoundsInt
  ToBoundsInt(this Rect rect) { // Bounds are 3d and require Z of at least 1 to
                                // work, so it's Z 0 -> 1 here
    return new BoundsInt(rect.min.RoundToInt(),
                         rect.size.RoundToInt() + ZOneVector3Int);
  }
