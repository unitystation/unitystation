...
public partial class MatrixManager : SingletonManager<MatrixManager>
{
	...
	public static BumpType GetBumpTypeAt(Vector3Int worldOrigin, Vector2Int dir, PlayerMove bumper, bool isServer,
		MatrixInfo MatrixAtOrigin = null)
	{
		...
		if (isPassable == false &&
		    GetPushableAt(worldOrigin, dir, bumper.gameObject, isServer, true, MatrixAtOrigin).Count > 0)
		{
	...
	public static bool IsPassableAtAllMatricesV2(Vector3Int worldOrigin, Vector3Int worldTarget,
		MatrixCash MatrixCash, GameObject Context, out PushPull PushIng  )
	{
		...
		bool IsPassable = MatrixOrigin.Matrix.MetaTileMap.IsPassableAtOneObjectsV2(localPosOrigin, localPosTarget, Context, out PushIng);
