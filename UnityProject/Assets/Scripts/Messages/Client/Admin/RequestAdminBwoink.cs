...
namespace Messages.Client.Admin
{
	public class RequestAdminBwoink : ClientMessage<RequestAdminBwoink.NetMessage>
	{
		...
		public override void Process(NetMessage msg)
		{
			...
			AdminBwoinkMessage.Send(recipient.GameObject, SentByPlayer.AccountId, $"<color=red>{SentByPlayer.Username}: {Managers.GameManager.Instance.RoundTime.ToString(@"hh\:mm\:ss") + " - " + msg.Message}</color>");
