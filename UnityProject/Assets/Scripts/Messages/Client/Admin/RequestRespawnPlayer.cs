...
public class RequestRespawnPlayer : ClientMessage
{
	...
	{
		string msg = $"{PlayerList.Instance.GetByUserID(Userid).Name} respawned dead player {deadPlayer.Name} as {occupation}";

		AdminLogging.Instance.AddToAdminChatAndLog(msg, Userid);
