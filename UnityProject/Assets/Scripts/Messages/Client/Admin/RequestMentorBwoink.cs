...
namespace Messages.Client.Admin
{
	public class RequestMentorBwoink : ClientMessage<RequestMentorBwoink.NetMessage>
	{
		...
		public override void Process(NetMessage msg)
		{
			...
			MentorBwoinkMessage.Send(recipient.GameObject, SentByPlayer.AccountId, $"<color=#6400FF>{SentByPlayer.Username}: { Managers.GameManager.Instance.RoundTime.ToString(@"hh\:mm\:ss") + " - " + msg.Message}</color>");
