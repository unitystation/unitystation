...
namespace Messages.Client.VariableViewer
{
	public class RequestInvokeFunction  : ClientMessage<RequestInvokeFunction.NetMessage>
	{
		...
		{
			if (IsFromAdmin("VV_CALL") == false) return;

			global::VariableViewer.RequestInvokeFunction(msg.PageID,msg.SendToClient ,  SentByPlayer.GameObject, SentByPlayer.AccountId);
		}
