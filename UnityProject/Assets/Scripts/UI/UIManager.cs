...
namespace UI
{
    public class UIManager : MonoBehaviour
    {
        ...
        {
            var slots = Instance.GetComponentsInChildren<UI_ItemSlot>();
            foreach (var slot in slots)
            {
                slot.Reset();
            }
            foreach (var listener in Instance.GetComponentsInChildren<DamageMonitorListener>())
            {
                listener.Reset();
            }
        }
        ...
        {
            foreach (var slot in Instance.inventorySlotCache)
            {
