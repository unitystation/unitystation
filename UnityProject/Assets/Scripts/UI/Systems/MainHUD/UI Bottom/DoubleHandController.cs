...
public class DoubleHandController : MonoBehaviour {
  ...
  public void
  AddHand(IDynamicItemSlotS bodyPartUISlots,
  ...
  /// <returns>To mark whether or not to destroy hand controller from no hands
  /// being Present in it</returns>
  public bool
  RemoveHand(BodyPartUISlots.StorageCharacteristics StorageCharacteristics) {
    switch (StorageCharacteristics.namedSlot) {
    case NamedSlot.leftHand:
