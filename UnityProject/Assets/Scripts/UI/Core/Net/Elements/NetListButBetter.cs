...
public class NetListButBetter<T> : NetUIStringElement
{
	...
	public override string Value
	{
		get
		{
			return JsonConvert.SerializeObject(ListElements);
		}
		set
		{
	...
	public void AddRange(List<T> addElements)
	{
		ListElements.AddRange(addElements);
		RegisterListChange();
		UpdatePeepers();
	}

	public void Replace(List<T> addElements)
	{
		ListElements = addElements;
		RegisterListChange();
		UpdatePeepers();
	}
