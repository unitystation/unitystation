...
public class GUI_Spawner : NetTab
{
	...
	public void HugMobByIndex( string index )
	{
		...
		if ( mob )
		{
			// JESTER SoundManager.PlayNetworkedAtPos( "Notice1", Provider.transform.position );
	...
	public void RemoveMobByIndex( string index )
	{
		...
		if ( mob )
		{
			...
			// JESTER SoundManager.PlayNetworkedAtPos( "Smash", mob.TrackedObject.transform.position );
