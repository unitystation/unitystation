...
namespace Antagonists
{
	...
	public class Assassinate : Objective
	{
		...
		{
			Target = PlayerList.Instance.InGamePlayers.Where(pl => pl.AccountId == attributes[0].PlayerID).ElementAt(0).Mind;
		...
		{
			Loggy.Warning("Unable to find any suitable assassination targets! Giving free objective", Category.Antags);
