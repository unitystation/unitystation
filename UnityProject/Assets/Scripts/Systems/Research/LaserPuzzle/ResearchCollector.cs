...
public class ResearchCollector : MonoBehaviour, IOnHitDetect, IMultitoolSlaveable, ICheckedInteractable<HandApply>
{
	...
	public void OnHitDetect(OnHitDetectData data)
	{
		...
		{
			Chat.AddActionMsgToChat(this.gameObject, " The Research Collector beeps and boops Stating it's missing a connection to a Research Laser Projector  ");
			return;
		}

		AssociatedResearchLaserProjector.RegisterDataFromCollector(Data.ResearchData);
