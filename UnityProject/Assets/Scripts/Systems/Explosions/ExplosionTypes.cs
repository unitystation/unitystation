...
//explosion types available to ExplosionComponent and ChemExplosion, you don't have to put your own explosion type here, but this will make it available to those components from editor
public class ExplosionTypes
{
	...
	public static readonly Dictionary<ExplosionType, ExplosionNode> NodeTypes = new Dictionary<ExplosionType, ExplosionNode>() //add your node type here
	{
            ...
            {ExplosionType.Foam, new ExplosionFoamNode()}
	};
}
