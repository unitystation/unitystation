...
namespace Weapons
{
	...
	*/
			...
			BodyPartType damageZone, bool isSuicideShot)
		{
			...
			// JESTER SoundManager.PlayAtPosition(FiringSound, shooter.transform.position, shooter);
		...
		{
			// JESTER SoundManager.PlayNetworkedAtPos("OutOfAmmoAlarm", transform.position, sourceObj: serverHolder);
		}

		private void PlayEmptySFX()
		{
			// JESTER SoundManager.PlayNetworkedAtPos("EmptyGunClick", transform.position, sourceObj: serverHolder);
		}
