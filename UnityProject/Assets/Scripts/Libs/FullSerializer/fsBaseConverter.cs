...
namespace FullSerializer
{
	...
	public abstract class fsBaseConverter
	{
		...
		public virtual object CreateInstance(fsData data, Type storageType)
		{
			...
			{
				throw new InvalidOperationException("Please override CreateInstance for " + GetType().FullName + "; the object graph for " + storageType +
		...
		{
			return fsResult.Fail(GetType().Name + " expected one of " + string.Join(", ", types.Select(t => t.ToString()).ToArray()) + " but got " +
			                     data.Type + " in " + data);
		}
