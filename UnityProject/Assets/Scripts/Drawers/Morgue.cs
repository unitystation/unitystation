...
#pragma warning restore CS0162 // Unreachable code detected
		...
		// JESTER SoundManager.PlayNetworkedAtPos("SnapCracklePop1", DrawerWorldPosition, sourceObj: gameObject);
	...
	private void ToggleBuzzer()
	{
		...
		// JESTER SoundManager.PlayNetworkedAtPos("Pop", DrawerWorldPosition, sourceObj: gameObject);
	...
	private IEnumerator PlayAlarm()
	{
		...
		{
			// JESTER SoundManager.PlayNetworkedAtPos("OutOfAmmoAlarm", DrawerWorldPosition, sourceObj: gameObject);
