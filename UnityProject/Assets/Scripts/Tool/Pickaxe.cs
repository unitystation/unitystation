...
public class Pickaxe : MonoBehaviour, ICheckedInteractable<PositionalHandApply>
{
	...
	public void ServerPerformInteraction(PositionalHandApply interaction)
	{
		...
		if (bar != null)
		{
			// JESTER SoundManager.PlayNetworkedAtPos("pickaxe#", interaction.WorldPositionTarget, sourceObj: interaction.Performer);
		}
	}
	...
	private void FinishMine(PositionalHandApply interaction)
	{
		...
		{
			// JESTER SoundManager.PlayNetworkedAtPos("BreakStone", interaction.WorldPositionTarget, sourceObj: interaction.Performer);
