...
namespace Util
{
	public static class SweetExtensions
	{
		...
		{
			if ( NetID != global::Util.NetId.Invalid && NetID != global::Util.NetId.Empty && CustomNetworkManager.Spawned.TryGetValue(NetID, out var Object  ))
			{
		...
		public static uint NetId(this GameObject go)
		{
			...
			{
				return global::Util.NetId.Invalid; //maxValue is invalid (see NetId.cs)
			}
		}
		...
		{
			if (go is global::Util.NetId.Empty or global::Util.NetId.Invalid)
			{
				return null;
			}
