...
namespace Util.Independent.FluentRichText.Styles
{
	public class LineHeightStrategy : IStyleStrategy
	{
		...
		public LineHeightStrategy(string amount)
		{
			...
			{
				Loggy.Error("RichText received invalid line height. Line height must be a pixel value (e.g., \"1\", \"2.5\"), a font unit value (e.g., \"1em\", \"-0.5em\"), or a percentage value (e.g., \"10%\", \"2.5%\").");
				return;
			}
