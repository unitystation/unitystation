...
public struct BetterBounds : IEquatable<BetterBounds> {
  ...
  public bool Intersects(BetterBounds OppositeMatrix,
                         out BetterBounds Overlap) {
    ...
    if (Contains(bottomLeft) || Contains(bottomRight) || Contains(topLeft) ||
        Contains(topRight) || OppositeMatrix.Contains(ThisbottomLeft) ||
        OppositeMatrix.Contains(ThisbottomRight) ||
        OppositeMatrix.Contains(ThistopLeft) ||
        OppositeMatrix.Contains(ThistopRight)) {
