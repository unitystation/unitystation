...
public class HolyBook: MonoBehaviour, IPredictedCheckedInteractable<PositionalHandApply>
{
	...
	public void ServerPerformInteraction(PositionalHandApply interaction)
	{
		...
		if (willHarm)
		{
			...
			// JESTER SoundManager.PlayNetworkedAtPos("GenericHit", interaction.WorldPositionTarget, sourceObj: interaction.Performer);
		}
		else  //Heal a bodypart if possible.
		{
			...
			if (!(LHB.OverallHealth >= LHB.maxHealth))
			{
				...
				// JESTER SoundManager.PlayNetworkedAtPos("PunchMiss", interaction.WorldPositionTarget, sourceObj: interaction.Performer);
			}
