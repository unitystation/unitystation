...
public class BodyPartUISlots : BodyPartModification, IDynamicItemSlotS
{
	...
	[SerializeField] [FormerlySerializedAs("RelatedStorage")]  private ItemStorage relatedStorage;

	public List<BodyPartUISlots.StorageCharacteristics> Storage => storage;


	[SerializeField] [FormerlySerializedAs("Storage")] private List<BodyPartUISlots.StorageCharacteristics> storage;
