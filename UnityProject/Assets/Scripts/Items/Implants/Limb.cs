...
public class Limb : BodyPartFunctionality, IMovementEffect {
  ...
  [SerializeField]
  [Tooltip(
      "The crawling speed used for when the limb is attached as an arm.\n")]
  private float crawlingSpeed = 0.3f;

  [SerializeField]
  [Tooltip(
      "A generalized number representing how efficient an arm this limb is.\n" +
      "1 is a human hand.")]
  private float armEfficiency = 1f;

  [SerializeField]
  [Tooltip(
      "A generalized number representing how efficient a leg this limb is.\n" +
      "1 is a human leg.")]
  ...
  public float RunningSpeedModifier =>
      runningSpeed * legEfficiency * bodyPart.TotalModified;

  public float WalkingSpeedModifier =>
      walkingSpeed * legEfficiency * bodyPart.TotalModified;

  public float CrawlingSpeedModifier =>
      crawlingSpeed * armEfficiency * bodyPart.TotalModified;

  public void ModifierChanged() { playerHealth.PlayerMove.UpdateSpeeds(); }
}
