...
public class OreBox : NetworkBehaviour, ICheckedInteractable<HandApply>, IServerDespawn
{
	...
	public void ServerPerformInteraction(HandApply interaction)
	{
		...
		{
			Chat.AddActionMsgToChat(interaction.Performer.gameObject, $"You empty out the {this.gameObject.DisplayName()} Quickly", $" {interaction.Performer} empties out the {this.gameObject.DisplayName()} Quickly");
