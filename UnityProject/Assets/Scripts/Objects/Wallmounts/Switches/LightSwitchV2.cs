...
{
	public class LightSwitchV2 : InterfaceGUI, SubscriptionController, ICheckedInteractable<HandApply>, IAPCPowerable, IMultitoolMasterable, ICheckedInteractable<AiActivate>
	{
