...
public class PosterBehaviour : NetworkBehaviour, ICheckedInteractable<HandApply>
{
	...
	public void ServerPerformInteraction(HandApply interaction)
	{
		...
		if (Validations.HasItemTrait(item, CommonTraits.Instance.Wirecutter))
		{
			// JESTER SoundManager.PlayNetworkedAtPos("WireCutter", pos, 1f, sourceObj: gameObject);
		...
		// JESTER SoundManager.PlayNetworkedAtPos("PosterRipped", pos, sourceObj: gameObject);
