...
public partial class TestAction {
  public bool ShowSetMousePosition =>
      SpecifiedAction == ActionType.SetMousePosition;

  [AllowNesting]
  [ShowIf("ShowSetMousePosition")]
  public SetMousePosition DataSetMousePosition;
  ...
  public class SetMousePosition {
    ...
    public bool Initiate(TestRunSO TestRunSO) {
      InputManagerWrapper.MousePosition =
