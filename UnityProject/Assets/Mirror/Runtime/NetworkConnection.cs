...
namespace Mirror
{
    ...
    public abstract class NetworkConnection : IDisposable
    {
        ...
        protected internal static bool ValidatePacketSize(ArraySegment<byte> segment, int channelId)
        {
            ...
            {
                Debug.LogError("NetworkConnection.ValidatePacketSize: cannot send packet larger than " + Transport.activeTransport.GetMaxPacketSize(channelId) + " bytes, was " + segment.Count);
                return false;
            }
