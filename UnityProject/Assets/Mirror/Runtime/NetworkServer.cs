...
namespace Mirror
{
	...
	public static class NetworkServer
	{
		...
		/// </summary>
		public static Dictionary<NetworkConnection, List<Scene>> observerSceneList =
			new Dictionary<NetworkConnection, List<Scene>>();
...
#pragma warning restore 618
			{
				///CUSTOM UNITYSTATION CODE///
				//Was removed from the if check, so that our custom scene check aslways works
