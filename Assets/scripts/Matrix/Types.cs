...
namespace Matrix {
	...
	[System.Flags] enum TileProperty { HasFloor = 1, AtmosNotPassable = 2, NotPassable = 4, PassableRestrictions = 8, WallMountable = 16, Chair = 32, IsItem = 128}
    ...
    public class TileType: Type {
		...
		public static TileType WallMount = new TileType("WallMount", (int) TileProperty.WallMountable);
