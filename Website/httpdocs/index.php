...
<head>
  ...
  <style>:root{--blue:#007bff;--indigo:#6610f2;--purple:#6f42c1;--pink:#e83e8c;--red:#dc3545;--orange:#fd7e14;--yellow:#ffc107;--green:#28a745;--teal:#20c997;--cyan:#17a2b8;--white:#fff;--gray:#868e96;--gray-dark:#343a40;--primary:#007bff;--secondary:#868e96;--success:#28a745;--info:#17a2b8;--warning:#ffc107;--danger:#dc3545;--light:#f8f9fa;--dark:#343a40;--breakpoint-xs:0;--breakpoint-sm:576px;--breakpoint-md:768px;--breakpoint-lg:992px;--breakpoint-xl:1200px;--font-family-sans-serif:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol";--font-family-monospace:"SFMono-Regular",Menlo,Monaco,Consolas,"Liberation Mono","Courier New",monospace}*,::after,::before{box-sizing:border-box}html{font-family:sans-serif;line-height:1.15;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;-ms-overflow-style:scrollbar}@-ms-viewport{width:device-width}nav{display:block}body{margin:0;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol";font-size:1rem;font-weight:400;line-height:1.5;color:#212529;text-align:left;background-color:#fff}h1,h3,h4{margin-top:0;margin-bottom:.5rem}p{margin-top:0;margin-bottom:1rem}ul{margin-top:0;margin-bottom:1rem}strong{font-weight:bolder}a{color:#007bff;text-decoration:none;background-color:transparent;-webkit-text-decoration-skip:objects}img{vertical-align:middle;border-style:none}a,button,input:not([type=range]){-ms-touch-action:manipulation;touch-action:manipulation}button{border-radius:0}button,input{margin:0;font-family:inherit;font-size:inherit;line-height:inherit}button,input{overflow:visible}button{text-transform:none}button,html [type=button]{-webkit-appearance:button}[type=button]::-moz-focus-inner,button::-moz-focus-inner{padding:0;border-style:none}::-webkit-file-upload-button{font:inherit;-webkit-appearance:button}h1,h3,h4{margin-bottom:.5rem;font-family:inherit;font-weight:500;line-height:1.2;color:inherit}h1{font-size:2.5rem}h3{font-size:1.75rem}h4{font-size:1.5rem}.container{width:100%;padding-right:15px;padding-left:15px;margin-right:auto;margin-left:auto}@media (min-width:576px){.container{max-width:540px}}@media (min-width:768px){.container{max-width:720px}}@media (min-width:992px){.container{max-width:960px}}@media (min-width:1200px){.container{max-width:1140px}}.row{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;margin-right:-15px;margin-left:-15px}.col-md-12,.col-md-6{position:relative;width:100%;min-height:1px;padding-right:15px;padding-left:15px}@media (min-width:768px){.col-md-6{-ms-flex:0 0 50%;flex:0 0 50%;max-width:50%}.col-md-12{-ms-flex:0 0 100%;flex:0 0 100%;max-width:100%}}.collapse{display:none}.nav-link{display:block;padding:.5rem 1rem}.navbar{position:relative;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-align:center;align-items:center;-ms-flex-pack:justify;justify-content:space-between;padding:.5rem 1rem}.navbar-brand{display:inline-block;padding-top:.3125rem;padding-bottom:.3125rem;margin-right:1rem;font-size:1.25rem;line-height:inherit;white-space:nowrap}.navbar-nav{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;padding-left:0;margin-bottom:0;list-style:none}.navbar-nav .nav-link{padding-right:0;padding-left:0}.navbar-collapse{-ms-flex-preferred-size:100%;flex-basis:100%;-ms-flex-positive:1;flex-grow:1;-ms-flex-align:center;align-items:center}.navbar-toggler{padding:.25rem .75rem;font-size:1.25rem;line-height:1;background:0 0;border:1px solid transparent;border-radius:.25rem}.navbar-toggler-icon{display:inline-block;width:1.5em;height:1.5em;vertical-align:middle;content:"";background:no-repeat center center;background-size:100% 100%}@media (min-width:992px){.navbar-expand-lg{-ms-flex-flow:row nowrap;flex-flow:row nowrap;-ms-flex-pack:start;justify-content:flex-start}.navbar-expand-lg .navbar-nav{-ms-flex-direction:row;flex-direction:row}.navbar-expand-lg .navbar-nav .nav-link{padding-right:.5rem;padding-left:.5rem}.navbar-expand-lg .navbar-collapse{display:-ms-flexbox!important;display:flex!important;-ms-flex-preferred-size:auto;flex-basis:auto}.navbar-expand-lg .navbar-toggler{display:none}}.flex-row{-ms-flex-direction:row!important;flex-direction:row!important}@supports ((position:-webkit-sticky) or (position:sticky)){.sticky-top{position:-webkit-sticky;position:sticky;top:0;z-index:1020}}.sr-only{position:absolute;width:1px;height:1px;padding:0;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;-webkit-clip-path:inset(50%);clip-path:inset(50%);border:0}.p-2{padding:.5rem!important}@media (min-width:768px){.ml-md-auto{margin-left:auto!important}}.text-center{text-align:center!important}.fab,.far,.fas{-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;display:inline-block;font-style:normal;font-variant:normal;text-rendering:auto;line-height:1}.fa-facebook:before{content:"\f09a"}.fa-github:before{content:"\f09b"}.fa-patreon:before{content:"\f3d9"}.fa-play-circle:before{content:"\f144"}.fa-reddit-alien:before{content:"\f281"}.fa-twitter:before{content:"\f099"}.fa-volume-off:before{content:"\f026"}.fa-youtube:before{content:"\f167"}.sr-only{border:0;clip:rect(0,0,0,0);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px}.fab{font-family:Font Awesome\ 5 Brands}.far{font-weight:400}.far,.fas{font-family:Font Awesome\ 5 Free}.fas{font-weight:900}@font-face{font-family:'Montserrat';font-style:normal;font-weight:400;src:local('Montserrat Regular'),local('Montserrat-Regular'),url(https://fonts.gstatic.com/s/montserrat/v12/zhcz-_WihjSQC0oHJ9TCYC3USBnSvpkopQaUR-2r7iU.ttf) format('truetype')}body{font-family:'Montserrat',sans-serif;font-weight:400;font-size:16px;background-color:#efefef;-webkit-font-smoothing:antialiased;-webkit-overflow-scrolling:touch;overflow-x:hidden}.margin-bottom-1rem{margin-bottom:1rem}.margin-top-30{margin-top:30px}.margin-bottom-30{margin-bottom:30px}.flex-center{display:flex;align-items:center;justify-content:center}.ss13-brand-image{width:48px;height:48px;margin-right:15px}.navbar-brand{font-weight:700;font-size:2rem;color:#fff!important}.navbar-custom-dark{background-color:#2f2f2f}.navbar-custom-dark a{color:#aaa}.videoWrapper{position:relative;width:100%;height:100%;margin:0 20%}.videoWrapper iframe{position:absolute;border:0;top:0;left:0;width:100%;height:100%}@media screen and (min-width:401px){.playButton{color:red;font-size:11rem}}@media screen and (max-width:400px){.playButton{color:red;font-size:8rem}}@media screen and (min-width:581px){.closePlayer{position:absolute;left:1%;color:#aaa;text-align:center;border:2px solid #aaa;padding:5px}}@media screen and (max-width:580px){.closePlayer{display:none;visibility:hidden}}@media screen and (min-width:581px){.closePlayerMob{display:none;visibility:hidden}}@media screen and (max-width:580px){.closePlayerMob{position:absolute;left:1%;color:#aaa;text-align:center;border:2px solid #aaa;padding-top:5px;padding-bottom:5px;padding-right:10px;padding-left:10px}}@media (min-width:992px){.container{max-width:940px}}@media (min-width:768px) and (max-width:991px){.container{max-width:720px}}@media (max-width:767px){.container{max-width:540px}}@media screen and (min-width:871px){.headerImage{background:url(http://unitystation.org/assets/img/xheader-min.png.pagespeed.ic.xDUx-TQ3pA.jpg) no-repeat center top;background-attachment:relative;background-position:center center;height:300px;background-size:cover}}@media screen and (max-width:870px) and (min-width:396px){.headerImage{background:url(http://unitystation.org/assets/img/xheaderlow-min.png.pagespeed.ic.WY7ogXR1sJ.jpg) no-repeat center top;background-attachment:relative;background-position:center center;height:210px;background-size:cover}}@media screen and (max-width:395px){.headerImage{background:url(http://unitystation.org/assets/img/xheadermob-min.png.pagespeed.ic.IOMaAwmVuw.jpg) no-repeat center top;background-attachment:relative;background-position:center center;height:150px;background-size:cover}}.about-image{width:200px}.ourProject{font-size:2.5rem;margin:2rem 0}.patreon-container{background-color:#f96854;color:#fff;padding-bottom:30px;margin-top:1rem;margin-bottom:3rem}.patreon-container a{color:#052d49}.honk{background-image:url(http://unitystation.org/assets/img/xclown.png.pagespeed.ic.XpJr66VBx1.png);width:50px;height:50px;background-size:100%;background-repeat:no-repeat;position:absolute;left:-100px;z-index:1;display:inline;animation-name:spin;animation-duration:4000ms;animation-iteration-count:infinite;animation-timing-function:linear}@-moz-keyframes spin{from{-moz-transform:rotate(0deg)}to{-moz-transform:rotate(360deg)}}@-webkit-keyframes spin{from{-webkit-transform:rotate(0deg)}to{-webkit-transform:rotate(360deg)}}@keyframes spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}.download-container{background-image:url(http://unitystation.org/assets/img/stars.png);background-repeat:repeat;background-attachment:fixed;color:#fff;position:relative;padding-bottom:2rem}.download-container-inner{position:relative;z-index:2}.version-container{display:flex;align-items:center;justify-content:center;color:#fff;font-weight:600;font-size:1.2rem}.download-image{margin:2rem 0;width:300px}.audio-button{background:0;color:#fff;border:0;position:absolute;margin:2rem;font-size:2rem;z-index:2}</style>
  <!-- Bootstrap core CSS -->
