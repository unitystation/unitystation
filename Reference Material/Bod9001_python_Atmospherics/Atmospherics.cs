...
namespace Atmospherics {
	...
	class Initialization {
		static void AirAndOtheresEncahon() {
			Dictionary < List < int > ,
			Dictionary < string,
			float >> DictionaryOfAdjacents = new Dictionary < List < int > ,
			Dictionary < string,
			float >> ();
		}
...

		{
			...
			List < int > temporaryList3 = new List < int > () { - 1,
				0
			};
		...
		static void MakingDictionaryOfAdjacents() {
			Dictionary < List < int > ,
			List < List < int >>> DictionaryOfAdjacents = new Dictionary < List < int > ,
			List < List < int >>> ();
			List < int > TileRange = new List < int > ();
			TileRange.Add(360);
			TileRange.Add(210);
		...
		static void MakingCheckCountDictionarys() {
			Dictionary < List < int > ,
			int > CheckCountDictionary = new Dictionary < List < int > ,
			int > ();
			Dictionary < List < int > ,
			int > CheckCountDictionaryMoving = new Dictionary < List < int > ,
			int > ();
